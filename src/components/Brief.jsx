...
const Brief = () => {
  ...
  return (
    <div className="mt-[25rem] lg:mt-24 mb-14 py-16 relative flex justify-center">
      <a
      ...
      <iframe
        ...
        className="relative w-full lg:h-[32rem] 2xl:h-[35rem]"
      ></iframe>
      {/* Form */}
      {/* sm:mx-4 md:mx-10 xl:mx-20 2xl:mx-[6.875rem] */}
      <div
        className={`absolute lg:left-10 xl:left-20 2xl:left-[6.875rem] 3xl:left-[50%-750px] bottom-[75%] lg:bottom-[7.56rem] w-[calc(100%-1.25rem)] sm:w-[calc(100%-2rem)] md:w-[calc(100%-5rem)] lg:w-[50%] 3xl:w-[45%]`}
      >
        <div
          style={{
            background:
