...
export default function OurOffers() {
  return (
    <div className="mt-6 md:mt-10 lg:mt-14 grid grid-cols-1 md:grid-cols-5">
      ...
      <div className="col-span-1 flex flex-col self-center md:col-span-3 md:ml-8 xl:ml-14 2xl:ml-20 ">
        ...
        <p className="font-abel mt-4 text-[10px] xs:text-[14px] lg:text-[16px] xl:text-[18px] 2xl:text-[20px] font-regular">
