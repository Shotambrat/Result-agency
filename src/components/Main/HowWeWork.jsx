...
const HowWeWork = () => {
  return (
    <div
      ...
      className="rounded-[8.73px] overflow-hidden mx-[0.625rem] my-8 xs:px-8 sm:px-0 sm:mx-4 md:mx-10 xl:mx-20 2xl:mx-[6.875rem] lg:mt-[3rem]"
    >
      <h2 className="text-[20px] xs:text-[24px] md:text-[36px] 2xl:text-[64px] font-bold text-center mt-4 xs:mt-6">
      ...
      <div className="grid grid-cols-5 sm:grid-cols-2 mt-6 justify-between sm:px-8 md:px-12 lg:px-[10%]">
        ...
        />
        <h3 className="text-[#4A448E] pr-2 text-[13px] xs:text-[15px] md:text-[20px] 2xl:text-[32px] col-span-3 sm:col-span-1">
      ...
      <div className="mx-[0.4375rem] xl:mb-8 2xl:mb-12 md:px-4 lg:px-8 xl:px-[8%] mt-10 grid grid-cols-1 sm:px-24 md:grid-cols-2 md:gap-x-[38px] gap-y-16 md:gap-y-[38px] pb-[13px]">
        <div className="order-1 relative px-[0.8125rem] border-2 border-solid border-[#ffffff] rounded-[14px]">
          <div className="absolute top-[-12%] left-[45%] md:top-[43%] 2xl:top-[38%] md:left-[-1.3rem] 2xl:left-[-2.2rem] bg-[#7B72EB] border-[4px] border-solid border-[#cccccc] w-10 h-10 2xl:w-16 2xl:h-16 rounded-full">
          ...
          <p className="text-[13px] xs:text-[16px] 2xl:text-[21.46px] text-[#191359] mt-3 mb-4 md:ml-8 2xl:ml-16 2xl:mr-10">
        ...
        <div className="order-2 relative px-[0.8125rem] border-2 border-solid border-[#ffffff] rounded-[14px]">
          <div className="absolute top-[-12%] left-[45%] md:top-[43%] 2xl:top-[38%] md:left-[-1.3rem] 2xl:left-[-2.2rem] bg-[#7B72EB] border-[4px] border-solid border-[#cccccc] w-10 h-10 2xl:w-16 2xl:h-16 rounded-full">
            <p className="text-[19.2px] 2xl:text-[40px] font-extrabold text-white text-center mt-[2px] 2xl:mt-0">
              2
            </p>
        ...
        <div className="order-3 md:order-4 relative px-[0.8125rem] border-2 border-solid border-[#ffffff] rounded-[14px]">
          <div className="absolute top-[-12%] left-[45%] md:top-[43%] 2xl:top-[38%] md:left-[-1.3rem] 2xl:left-[-2.2rem] bg-[#7B72EB] border-[4px] border-solid border-[#cccccc] w-10 h-10 2xl:w-16 2xl:h-16 rounded-full">
            <p className="text-[19.2px] 2xl:text-[40px] font-extrabold text-white text-center mt-[2px] 2xl:mt-0">
              3
            </p>
        ...
        <div className="order-4 md:order-3 relative px-[0.8125rem] border-2 border-solid border-[#ffffff] rounded-[14px]">
          <div className="absolute top-[-12%] left-[45%] md:top-[43%] 2xl:top-[38%] md:left-[-1.3rem] 2xl:left-[-2.2rem] bg-[#7B72EB] border-[4px] border-solid border-[#cccccc] w-10 h-10 2xl:w-16 2xl:h-16 rounded-full">
            <p className="text-[19.2px] 2xl:text-[40px] font-extrabold text-white text-center mt-[2px] 2xl:mt-0">
              4
            </p>
        ...
        <div className="order-5 relative px-[0.8125rem] border-2 border-solid border-[#ffffff] rounded-[14px]">
          <div className="absolute top-[-12%] left-[45%] md:top-[43%] 2xl:top-[38%] md:left-[-1.3rem] 2xl:left-[-2.2rem] bg-[#7B72EB] border-[4px] border-solid border-[#cccccc] w-10 h-10 2xl:w-16 2xl:h-16 rounded-full">
            <p className="text-[19.2px] 2xl:text-[40px] font-extrabold text-white text-center mt-[2px] 2xl:mt-0">
              5
            </p>
        ...
        <div className="order-6 relative px-[0.8125rem] border-2 border-solid border-[#ffffff] rounded-[14px]">
          <div className="absolute top-[-12%] left-[45%] md:top-[43%] 2xl:top-[38%] md:left-[-1.3rem] 2xl:left-[-2.2rem] bg-[#7B72EB] border-[4px] border-solid border-[#cccccc] w-10 h-10 2xl:w-16 2xl:h-16 rounded-full">
            <p className="text-[19.2px] 2xl:text-[40px] font-extrabold text-white text-center mt-[2px] 2xl:mt-0">
              6
            </p>
