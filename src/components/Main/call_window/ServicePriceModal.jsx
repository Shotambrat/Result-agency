...
export default function ServiceModal({
  ...
  let liStyle =
    "text-[14px] list-disc text-left text-white font-light m:text-[14.5px] l:my-[2px] s:text-[15px] xs:text-[17px] sm:text-[18.5px] md:text-[19.5px] lg:text-[21.5px] xl:text-[23px] 2xl:my-[0px]";

  return (
    <div
      onClick={handleClickOutside}
      className="fixed inset-0 flex items-center justify-center z-[21] backdrop-blur-md shadow-md"
    >
      <div
        ref={modalRef}
        className="max-h-[90vh] overflow-y-auto custom-scrollbar p-4 w-11/12 rounded-[11px] m:p-6 xs:px-7 xs:py-7 sm:px-9 2xl:p-10 2xl:w-3/4 lg:rounded-[41px] bg-gradient-to-b from-[#746FAE] to-[#8A66F0] flex items-start justify-center flex-col sm:overflow-y-auto lg:px-9 lg:py-9 price-list"
      >
        <div className="w-full mb-[10px] flex justify-between align-baseline flex-row-reverse">
          <button
            className="block bg-transparent border-none close-button ml-0"
            onClick={close}
          >
            <svg
              className="mb-[3px] w-[18px] h-[20px] l:mb-[0px] xs:w-[23px] xs:h-[25px] lg:w-[30px] lg:h-[34px] xl:w-[29px] xl:h-[31px] svg-img-close"
        ...
        <ul className="service-price-modal h-full w-auto ml-[7.3px] m:ml-[10px] lg:p-4 lg:px-8 s:ml-[15px] xs:ml-[20px] custom-scrollbar overflow-y-auto">
          ...
          {!(
            ...
            <li className={liStyle}>
              {t(`service-modal-${modal}-size${defaultNumber}`)}
            </li>
          )}
          {!(name === "smm" && (defaultNumber == 2 || defaultNumber == 3)) && (
            <li className={liStyle}>
              {t(`service-modal-${modal}-duration${defaultNumber}`)}
            </li>
          )}
          {name === "smm" ? (
            <ul>
              ...
              {defaultNumber != 1 &&
                ...
                defaultNumber != 3 && (
                  <>
                    ...
                    <li className={liStyle}>
                      {t(`service-modal-${modal}-webDev${defaultNumber}`)}
                    </li>
                  </>
                )}
              <li></li>
            ...
            <ul >
              ...
              {name === "sites" && defaultNumber === 3 && (
                <li className={liStyle}>
                  {t(`service-modal-${modal}-blog${defaultNumber}`)}
                </li>
              )}
              <li></li>
            </ul>
          ...
          <li className={liStyle}>
            {t(`service-modal-${modal}-condition${defaultNumber}`)}
          </li>
                ...
                <thead>
                  <tr className="bg-keys_item-bg text-white">
                    <th className="px-4 py-2">
                      {t(`service-modal-smm-title-1`)}
                    </th>
                    <th className="px-4 py-2">
                      {t(`service-modal-smm-title-2`)}
                    </th>
                    <th className="px-4 py-2">
                      {t(`service-modal-smm-title-3`)}
                    </th>
                    <th className="px-4 py-2">
                      {t(`service-modal-smm-title-4`)}
                    </th>
                  </tr>
                </thead>
                <tbody>
                  <tr className="bg-keys_item-bg text-white">
                    ...
                    <td className="border px-4 py-2">
                      {t(`service-modal-smm-content-${defaultNumber}-2`)}
                    </td>
                    <td className="border px-4 py-2">
                      {t(`service-modal-smm-content-${defaultNumber}-3`)}
                    </td>
                  </tr>
                  <tr className="bg-keys_item-bg text-white">
                    ...
                    <td className="border px-4 py-2">
                      {t(`service-modal-smm-content-${defaultNumber}-5`)}
                    </td>
                    <td className="border px-4 py-2">
                      {t(`service-modal-smm-content-${defaultNumber}-6`)}
                    </td>
                  </tr>
                  <tr className="bg-keys_item-bg text-white">
                    ...
                    <td className="border px-4 py-2">
                      {t(`service-modal-smm-content-${defaultNumber}-8`)}
                    </td>
                    <td className="border px-4 py-2">
                      {t(`service-modal-smm-content-${defaultNumber}-9`)}
                    </td>
                  </tr>
                  <tr className="bg-keys_item-bg text-white">
                    ...
                    <td className="border px-4 py-2">
                      {t(`service-modal-smm-content-${defaultNumber}-11`)}
                    </td>
                    <td className="border px-4 py-2">
                      {t(`service-modal-smm-content-${defaultNumber}-12`)}
                    </td>
                  </tr>
                  <tr className="bg-keys_item-bg text-white">
                    ...
                    <td class="border px-4 py-2">
                      {t(`service-modal-smm-content-${defaultNumber}-14`)}
                    </td>
                    <td class="border px-4 py-2">
                      {t(`service-modal-smm-content-${defaultNumber}-15`)}
                    </td>
                  </tr>
                  <tr className="bg-keys_item-bg text-white">
                    ...
                    <td className="border px-4 py-2">
                      {t(`service-modal-smm-content-${defaultNumber}-17`)}
                    </td>
                    <td className="border px-4 py-2">
                      {t(`service-modal-smm-content-${defaultNumber}-18`)}
                    </td>
                  </tr>
                  {defaultNumber === 1 ? (
                    <div></div>
                    ...
                    <>
                      <tr className="bg-keys_item-bg text-white">
                        ...
                        <td className="border px-4 py-2">
                          {t(`service-modal-smm-content-${defaultNumber}-20`)}
                        </td>
                        <td className="border px-4 py-2">
                          {t(`service-modal-smm-content-${defaultNumber}-21`)}
                        </td>
                      </tr>
                      <tr className="bg-keys_item-bg text-white">
                        ...
                        <td className="border px-4 py-2">
                          {t(`service-modal-smm-content-${defaultNumber}-23`)}
                        </td>
                        <td className="border px-4 py-2">
                          {t(`service-modal-smm-content-${defaultNumber}-24`)}
                        </td>
                      </tr>
                    </>
                  )}
            ...
            <div>
              ...
              {((name === "bot" && defaultNumber === 2) ||
                ...
                <>
                  ...
                  <li className={liStyle}>
                    {t(`service-modal-${modal}-botupdate${defaultNumber}`)}
                  </li>
                  <li className={liStyle}>
