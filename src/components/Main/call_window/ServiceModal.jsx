          ...
          <div class="h-full relative block text-left py-2 px-1.5 m:px-2 l:py-1 l:px-1.5 xs:px-1 xl:py-4 ">
            {servicesData.map((elem, index) => {
              ...
              <div className='absolute right-0 bottom-1 flex justify-end items-center'>
                <button className="w-[15px] h-[10px] mb-1 mr-4 close-button m:mr-3 w-[20px] m:h-[16px] l:mr-5 l:w-[23px] l:h-[19px] lg:w-[27px] lg:h-[23px] lg:mr-7 2xl:w-[50px] 2xl:h-[28px] 2xl:mb-4" onClick={close}>
