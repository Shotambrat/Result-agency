...
const MainCases = () => {
  ...
  const cases1 = [{image: case1}, {image: case2}, {image: case3}, {image: case4}, {image: case5}];
        ...
        {cases1.map((elem, index) => (
          <div key={index} className="">
            <Link onClick={() => toTop()} to={`/cases/${index + 1}`}>
              ...
              <img src={elem.image} alt={`case-${index + 1}`} className="w-full h-full object-cover rounded-[7.39px] lg:rounded-3xl" />
              </div>
            </Link>
